...
values
  ...
  ('jamidusu-gunghap', '자미두수 궁합', '자미두수 명반으로 두 사람의 인연과 궁합을 깊이 있게 분석', 8900, null, 60, true),
  ('jamidusu-jaehoe', '자미두수 재회운', '헤어진 인연과의 재회 가능성과 시기·흐름을 자미두수로 풀이', 14900, null, 70, true)
